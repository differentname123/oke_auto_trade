...
if __name__ == "__main__":
    ...
    newest_data = LatestDataManager(1000, INST_ID)
    ...
    while count > 0:
        try:
            ...
            # long_sz, short_sz, avg_long_price, avg_short_price = get_position_ratio(INST_ID, latest_price)
            ...
            place_order(
                ...
                tp_price=min_price + profit * latest_price   # 止盈价格
            )
            ...
            place_order(
                ...
                tp_price=max_price - profit * latest_price  # 止盈价格
            )
